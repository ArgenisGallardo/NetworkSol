...
<head>
	...
	<link rel="icon" href ="\resources\Network.ico" type="image/x-icon">
	<style>
		#parallax {
			/* The image used */
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mx-auto">
					<li class="nav-item @if ($Active=='Home') active @endif"><a class="nav-link" href="/index">Home<span class="sr-only">(current)</span></a></li>
					<li class="nav-item @if ($Active=='Servicios') active @endif"><a class="nav-link" href="/servicios">Servicios</a></li>
					<li class="nav-item @if ($Active=='Nosotros') active @endif"><a class="nav-link" href="/nosotros">Nosotros</a></li>
					<li class="nav-item @if ($Active=='Planes') active @endif"><a class="nav-link" href="/planes">Planes</a></li>
					<li class="nav-item @if ($Active=='Portafolio') active @endif"><a class="nav-link" href="/portafolio">Portafolio</a></li>
					<li class="nav-item @if ($Active=='Tienda') active @endif"><a class="nav-link" href="/tienda">Tienda</a></li>
					<li class="nav-item @if ($Active=='Blog') active @endif"><a class="nav-link" href="/blog">Blog</a></li>
				</ul>
